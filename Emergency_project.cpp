...
void search(int n,product* prod){
  ...
  if (list_position==0){
    ...
    void display(product * &p1,int n1){
      ...
      cout<<endl;
      for(int j=1;j<n1;j++){
        fout<<setw(w+4)<<p1[j].name<<setw(10)<<p1[j].code<<setw(10)<<p1[j].quantity<<setw(10)<<p1[j].cost<<setw(14)<<p1[j].selling_cost<<setw(10)<<p1[j].number_sold<<setw(14)<<p1[j].e_dd<<" "<<p1[j].e_mm<<" "<<p1[j].e_year<<endl;
        cout<<setw(w+4)<<p1[j].name<<setw(10)<<p1[j].code<<setw(10)<<p1[j].quantity<<setw(10)<<p1[j].cost<<setw(14)<<p1[j].selling_cost<<setw(10)<<p1[j].number_sold<<setw(14)<<p1[j].e_dd<<" "<<p1[j].e_mm<<" "<<p1[j].e_year<<endl;
      }
      fout.close();
    }
